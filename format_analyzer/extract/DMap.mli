...
val coq_TCMap_rect :
  ('a3 -> ('a3 -> bool) -> ('a1 -> 'a3 -> 'a2) -> ('a1 -> 'a2 -> 'a3 -> 'a3)
  -> ('a1 -> 'a2 -> 'a3 -> 'a3) -> ('a1 -> 'a2 -> 'a3 -> 'a3) -> ('a1 -> 'a3
  -> 'a3) -> (('a2 -> 'a2) -> 'a3 -> 'a3) -> (('a1 -> 'a2 -> 'a2) -> 'a3 ->
  'a3) -> (('a1 -> 'a2 -> bool) -> 'a3 -> 'a3) -> (__ -> ('a2 -> __ -> __) ->
  'a3 -> __ -> __) -> (__ -> ('a1 -> 'a2 -> __ -> __) -> 'a3 -> __ -> __) ->
  ('a3 -> ('a1 * 'a2) list) -> ('a3 -> int) -> (('a1 -> 'a2 -> unit) -> ('a1
  -> 'a2 -> bool) -> 'a3 -> bool) -> 'a4) -> ('a1, 'a2, 'a3) coq_TCMap -> 'a4
...
val map_weak_add : ('a1, 'a2, 'a3) coq_TCMap -> 'a1 -> 'a2 -> 'a3 -> 'a3

val map_fast_weak_add : ('a1, 'a2, 'a3) coq_TCMap -> 'a1 -> 'a2 -> 'a3 -> 'a3

val map_remove : ('a1, 'a2, 'a3) coq_TCMap -> 'a1 -> 'a3 -> 'a3

val map_map : ('a1, 'a2, 'a3) coq_TCMap -> ('a2 -> 'a2) -> 'a3 -> 'a3

val map_mapi : ('a1, 'a2, 'a3) coq_TCMap -> ('a1 -> 'a2 -> 'a2) -> 'a3 -> 'a3
...
val map_elements : ('a1, 'a2, 'a3) coq_TCMap -> 'a3 -> ('a1 * 'a2) list
  ...
  module M : 
   sig 
       ...
       sig 
        ...
        module L : 
         sig 
          ...
          | R_fold_1 of (key -> 'elt -> 'a -> 'a) * 'elt t * 'a * A__1.t
             * 'elt * (A__1.t * 'elt) list * 'a * ('elt, 'a) coq_R_fold
          
          val coq_R_fold_rect :
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> __ -> 'a2) ->
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> A__1.t -> 'a1
            -> (A__1.t * 'a1) list -> __ -> __ -> ('a1, __) coq_R_fold -> 'a2
          ...
          val fold_rect :
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> __ -> 'a2) ->
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> A__1.t -> 'a1
            -> (A__1.t * 'a1) list -> __ -> 'a2 -> 'a2) -> (key -> 'a1 -> 'a3
            -> 'a3) -> 'a1 t -> 'a3 -> 'a2
          ...
          | R_equal_2 of 'elt t * 'elt t * A__1.t * 'elt
             * (A__1.t * 'elt) list * A__1.t * 'elt * (A__1.t * 'elt) list
             * A__1.t OrderedType.coq_Compare
          ...
          val coq_R_equal_rect :
            ...
            (A__1.t * 'a1) list -> __ -> A__1.t OrderedType.coq_Compare -> __
    ...
    val map_induction_max :
      ('a1 t -> __ -> 'a2) -> ('a1 t -> 'a1 t -> 'a2 -> A__1.t -> 'a1 -> __
      -> __ -> 'a2) -> 'a1 t -> 'a2
