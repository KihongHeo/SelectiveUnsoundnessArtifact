...
module ArrayBlk : 
 sig 
   ...
   sig 
    ...
    module Raw : 
     sig 
      ...
      val mem : (string_t * t', (unit, string_t) sum) sum -> 'a1 tree -> bool
        ...
        module L : 
         sig 
          ...
          val coq_R_mem_rect :
            ...
            sum * 'a1) list -> __ -> __ -> __ -> bool -> 'a1 coq_R_mem -> 'a2
          ...
          val mem_rect :
            ...
            __ -> __ -> 'a2) -> ('a1 t -> (string_t * t', (unit, string_t)
            sum) sum -> 'a1 -> ((string_t * t', (unit, string_t) sum)
            sum * 'a1) list -> __ -> __ -> __ -> 'a2 -> 'a2) -> 'a1 t -> 'a2
          ...
          val coq_R_find_rect :
            ...
            __ -> __ -> 'a2) -> ('a1 t -> (string_t * t', (unit, string_t)
            sum) sum -> 'a1 -> ((string_t * t', (unit, string_t) sum)
            sum * 'a1) list -> __ -> __ -> __ -> 'a1 option -> 'a1 coq_R_find
          ...
          val coq_R_add_rect :
            ...
            string_t) sum) sum * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1
            t -> (string_t * t', (unit, string_t) sum) sum -> 'a1 ->
            ((string_t * t', (unit, string_t) sum) sum * 'a1) list -> __ ->
            __ -> __ -> 'a2) -> ('a1 t -> (string_t * t', (unit, string_t)
            sum) sum -> 'a1 -> ((string_t * t', (unit, string_t) sum)
          ...
          val coq_R_fold_rect :
            ...
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> (string_t * t',
            (unit, string_t) sum) sum -> 'a1 -> ((string_t * t', (unit,
            string_t) sum) sum * 'a1) list -> __ -> __ -> ('a1, __)
          ...
          val fold_rect :
            ...
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> (string_t * t',
            (unit, string_t) sum) sum -> 'a1 -> ((string_t * t', (unit,
            string_t) sum) sum * 'a1) list -> __ -> 'a2 -> 'a2) -> (key ->
            'a1 -> 'a3 -> 'a3) -> 'a1 t -> 'a3 -> 'a2
          ...
          val coq_R_equal_rect :
            ...
            (string_t * t', (unit, string_t) sum) sum -> 'a1 ->
            ((string_t * t', (unit, string_t) sum) sum * 'a1) list -> __ ->
            (string_t * t', (unit, string_t) sum) sum OrderedType.coq_Compare
          ...
          val equal_rect :
            ...
            'a1 t -> 'a1 t -> __ -> 'a1 t -> __ -> __ -> 'a2) -> 'a1 t -> 'a1
            t -> 'a2
  ...
  val find : (string_t * t', (unit, string_t) sum) sum -> t -> ArrInfo.t
  
  val add : (string_t * t', (unit, string_t) sum) sum -> ArrInfo.t -> t -> t
  ...
  val widen' : ArrInfo.t option -> ArrInfo.t option -> ArrInfo.t option
  
  val widen : t -> t -> t
  
  val narrow' : ArrInfo.t option -> ArrInfo.t option -> ArrInfo.t option
