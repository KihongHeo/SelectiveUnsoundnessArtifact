      ...
      module Proofs : 
       sig 
        ...
        module L : 
         sig 
          ...
          val coq_R_add_rect :
            ...
            (X.t * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t -> X.t ->
            'a1 -> (X.t * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
            X.t -> 'a1 -> (X.t * 'a1) list -> __ -> __ -> __ -> 'a1 t -> 'a1
          ...
          val coq_R_equal_rect :
            ...
            X.t OrderedType.coq_Compare -> __ -> __ -> 'a2) -> ('a1 t -> 'a1
          ...
          val equal_rect :
            ('a1 -> 'a1 -> bool) -> ('a1 t -> 'a1 t -> __ -> __ -> 'a2) ->
            ('a1 t -> 'a1 t -> X.t -> 'a1 -> (X.t * 'a1) list -> __ -> X.t ->
            'a1 -> (X.t * 'a1) list -> __ -> __ -> __ -> 'a2 -> 'a2) -> ('a1
            t -> 'a1 t -> X.t -> 'a1 -> (X.t * 'a1) list -> __ -> X.t -> 'a1
            -> (X.t * 'a1) list -> __ -> X.t OrderedType.coq_Compare -> __ ->
        ...
        val coq_R_remove_min_rect :
          ...
          -> __ -> ('a1 tree * (key * 'a1)) -> 'a1 coq_R_remove_min -> 'a2 ->
        ...
        | R_map2_opt_2 of 'elt tree * 'elt' tree * 'elt tree * key * 
           'elt * 'elt tree * I.t * 'elt' tree * key * 'elt' * 'elt' tree
           * I.t * 'elt' tree * 'elt' option * 'elt' tree * 'elt''
  ...
  module P : 
   sig 
    ...
    val coq_R_remove_min_rect :
      ...
      -> 'a1 MapS.Raw.tree -> MapS.Raw.key -> 'a1 -> 'a1 MapS.Raw.tree -> I.t
      -> __ -> ('a1 MapS.Raw.tree * (MapS.Raw.key * 'a1)) -> 'a1
    ...
    | R_merge_2 of 'elt MapS.Raw.tree * 'elt MapS.Raw.tree
       ...
       * I.t * 'elt MapS.Raw.tree * (MapS.Raw.key * 'elt) * MapS.Raw.key
       * 'elt
    ...
    val coq_R_merge_rect :
      ...
      MapS.Raw.tree -> (MapS.Raw.key * 'a1) -> __ -> MapS.Raw.key -> 'a1 ->
    ...
    | R_concat_2 of 'elt MapS.Raw.tree * 'elt MapS.Raw.tree
       * 'elt MapS.Raw.tree * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree * 
       I.t * 'elt MapS.Raw.tree * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree
       * I.t * 'elt MapS.Raw.tree * (MapS.Raw.key * 'elt)
    ...
    val coq_R_concat_rect :
      ...
      -> 'a1 -> 'a1 MapS.Raw.tree -> I.t -> __ -> 'a1 MapS.Raw.tree ->
      MapS.Raw.key -> 'a1 -> 'a1 MapS.Raw.tree -> I.t -> __ -> 'a1
      MapS.Raw.tree -> (MapS.Raw.key * 'a1) -> __ -> 'a2) -> 'a1
    ...
    | R_map_option_1 of 'elt MapS.Raw.tree * 'elt MapS.Raw.tree
       * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree * I.t * 'elt'
       * 'elt' MapS.Raw.tree * ('elt, 'elt') coq_R_map_option
       * 'elt' MapS.Raw.tree * ('elt, 'elt') coq_R_map_option
    | R_map_option_2 of 'elt MapS.Raw.tree * 'elt MapS.Raw.tree
       * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree * I.t * 'elt' MapS.Raw.tree
       * ('elt, 'elt') coq_R_map_option * 'elt' MapS.Raw.tree
       * ('elt, 'elt') coq_R_map_option
    ...
    | R_map2_opt_2 of 'elt MapS.Raw.tree * 'elt' MapS.Raw.tree
       * 'elt MapS.Raw.tree * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree * 
       I.t * 'elt' MapS.Raw.tree * MapS.Raw.key * 'elt' * 'elt' MapS.Raw.tree
       * I.t * 'elt' MapS.Raw.tree * 'elt' option * 'elt' MapS.Raw.tree
       * 'elt'' * 'elt'' MapS.Raw.tree * ('elt, 'elt', 'elt'') coq_R_map2_opt
       * 'elt'' MapS.Raw.tree * ('elt, 'elt', 'elt'') coq_R_map2_opt
  ...
  module P : 
   sig 
    ...
    val coq_R_remove_min_rect :
      ...
      Int.Z_as_Int.t -> __ -> ('a1 MapS.Raw.tree * (MapS.Raw.key * 'a1)) ->
      'a1 coq_R_remove_min -> 'a2 -> 'a1 MapS.Raw.tree ->
      (MapS.Raw.key * 'a1) -> __ -> 'a2) -> 'a1 MapS.Raw.tree -> MapS.Raw.key
      -> 'a1 -> 'a1 MapS.Raw.tree -> ('a1
      MapS.Raw.tree * (MapS.Raw.key * 'a1)) -> 'a1 coq_R_remove_min -> 'a2
    ...
    val coq_R_merge_rect :
      ...
      MapS.Raw.tree -> MapS.Raw.key -> 'a1 -> 'a1 MapS.Raw.tree ->
      Int.Z_as_Int.t -> __ -> 'a1 MapS.Raw.tree -> (MapS.Raw.key * 'a1) -> __
      -> MapS.Raw.key -> 'a1 -> __ -> 'a2) -> 'a1 MapS.Raw.tree -> 'a1
    ...
    | R_map_option_1 of 'elt MapS.Raw.tree * 'elt MapS.Raw.tree
       * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree * Int.Z_as_Int.t * 
       'elt' * 'elt' MapS.Raw.tree * ('elt, 'elt') coq_R_map_option
       * 'elt' MapS.Raw.tree * ('elt, 'elt') coq_R_map_option
    | R_map_option_2 of 'elt MapS.Raw.tree * 'elt MapS.Raw.tree
       * MapS.Raw.key * 'elt * 'elt MapS.Raw.tree * Int.Z_as_Int.t
       * 'elt' MapS.Raw.tree * ('elt, 'elt') coq_R_map_option
