   ...
   sig 
    module Raw : 
     sig 
      ...
      val compare_more :
        string_t -> (enumeration -> comparison) -> enumeration -> comparison
      ...
      type coq_R_bal =
      | R_bal_0 of t * string_t * t
      | R_bal_1 of t * string_t * t * Int.Z_as_Int.t * tree * string_t * tree
      | R_bal_2 of t * string_t * t * Int.Z_as_Int.t * tree * string_t * tree
      | R_bal_3 of t * string_t * t * Int.Z_as_Int.t * tree * string_t * 
         tree * Int.Z_as_Int.t * tree * string_t * tree
      | R_bal_4 of t * string_t * t
      | R_bal_5 of t * string_t * t * Int.Z_as_Int.t * tree * string_t * tree
      | R_bal_6 of t * string_t * t * Int.Z_as_Int.t * tree * string_t * tree
      | R_bal_7 of t * string_t * t * Int.Z_as_Int.t * tree * string_t * 
         tree * Int.Z_as_Int.t * tree * string_t * tree
      | R_bal_8 of t * string_t * t
      ...
      type coq_R_remove_min =
      | R_remove_min_0 of tree * elt * t
      | R_remove_min_1 of tree * elt * t * Int.Z_as_Int.t * tree * string_t
...
module NodeMap : 
 sig 
   ...
   sig 
    ...
    module Proofs : 
     sig 
      ...
      module L : 
       sig 
        ...
        val coq_R_mem_rect :
          ...
          ((string_t * t') * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
          (string_t * t') -> 'a1 -> ((string_t * t') * 'a1) list -> __ -> __
          -> __ -> 'a2) -> ('a1 t -> (string_t * t') -> 'a1 ->
        ...
        | R_find_3 of 'elt t * (string_t * t') * 'elt
           * ((string_t * t') * 'elt) list * 'elt option * 'elt coq_R_find
        ...
        val coq_R_find_rect :
          ...
          (string_t * t') -> 'a1 -> ((string_t * t') * 'a1) list -> __ -> __
          -> __ -> 'a2) -> ('a1 t -> (string_t * t') -> 'a1 ->
          ((string_t * t') * 'a1) list -> __ -> __ -> __ -> 'a1 option -> 'a1
        ...
        val coq_R_add_rect :
          ...
          ('a1 t -> (string_t * t') -> 'a1 -> ((string_t * t') * 'a1) list ->
          __ -> __ -> __ -> 'a2) -> ('a1 t -> (string_t * t') -> 'a1 ->
          ((string_t * t') * 'a1) list -> __ -> __ -> __ -> 'a1 t -> 'a1
        ...
        val coq_R_fold_rect :
          (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> __ -> 'a2) -> (__
          -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> (string_t * t') ->
          'a1 -> ((string_t * t') * 'a1) list -> __ -> __ -> ('a1, __)
        ...
        val fold_rect :
          (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> __ -> 'a2) -> (__
          -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> (string_t * t') ->
          'a1 -> ((string_t * t') * 'a1) list -> __ -> 'a2 -> 'a2) -> (key ->
          'a1 -> 'a3 -> 'a3) -> 'a1 t -> 'a3 -> 'a2
        ...
        val coq_R_equal_rect :
          ('a1 -> 'a1 -> bool) -> ('a1 t -> 'a1 t -> __ -> __ -> 'a2) -> ('a1
          t -> 'a1 t -> (string_t * t') -> 'a1 -> ((string_t * t') * 'a1)
          list -> __ -> (string_t * t') -> 'a1 -> ((string_t * t') * 'a1)
          list -> __ -> __ -> __ -> bool -> 'a1 coq_R_equal -> 'a2 -> 'a2) ->
        ...
        val equal_rect :
          ...
          (string_t * t') -> 'a1 -> ((string_t * t') * 'a1) list -> __ ->
          (string_t * t') OrderedType.coq_Compare -> __ -> __ -> 'a2) -> ('a1
      ...
      val coq_R_mem_rect :
        (string_t * t') -> ('a1 tree -> __ -> 'a2) -> ('a1 tree -> 'a1 tree
        -> key -> 'a1 -> 'a1 tree -> Int.Z_as_Int.t -> __ -> __ -> __ -> bool
        -> 'a1 coq_R_mem -> 'a2 -> 'a2) -> ('a1 tree -> 'a1 tree -> key ->
        'a1 -> 'a1 tree -> Int.Z_as_Int.t -> __ -> __ -> __ -> 'a2) -> ('a1
        tree -> 'a1 tree -> key -> 'a1 -> 'a1 tree -> Int.Z_as_Int.t -> __ ->
        __ -> __ -> bool -> 'a1 coq_R_mem -> 'a2 -> 'a2) -> 'a1 tree -> bool
        -> 'a1 coq_R_mem -> 'a2
  ...
  val map_induction_max :
    ('a1 t -> __ -> 'a2) -> ('a1 t -> 'a1 t -> 'a2 -> (string_t * t') -> 'a1
    -> __ -> __ -> 'a2) -> 'a1 t -> 'a2
   ...
   sig 
    module X' : 
     sig 
      ...
      val compare : (string_t * t') -> (string_t * t') -> comparison
     end
     ...
     sig 
      module Raw : 
       sig 
        ...
        type tree =
        | Leaf
        | Node of Int.Z_as_Int.t * tree * (string_t * t') * tree
        
        val empty : tree
        
        val is_empty : tree -> bool
        
        val mem : (string_t * t') -> tree -> bool
        ...
        val elements_aux :
          (string_t * t') list -> tree -> (string_t * t') list
        
        val elements : tree -> (string_t * t') list
        
        val rev_elements_aux :
          (string_t * t') list -> tree -> (string_t * t') list
        
        val rev_elements : tree -> (string_t * t') list
        ...
        val compare_more :
          (string_t * t') -> (enumeration -> comparison) -> enumeration ->
          comparison
        ...
        val subsetl : (tree -> bool) -> (string_t * t') -> tree -> bool
        
        val subsetr : (tree -> bool) -> (string_t * t') -> tree -> bool
        ...
        val singleton : (string_t * t') -> tree
        
        val create : t -> (string_t * t') -> t -> tree
        
        val assert_false : t -> (string_t * t') -> t -> tree
        
        val bal : t -> (string_t * t') -> t -> tree
        
        val add : (string_t * t') -> tree -> tree
        ...
        val remove : (string_t * t') -> tree -> tree
        ...
        val split : (string_t * t') -> tree -> triple
        ...
        val ltb_tree : (string_t * t') -> tree -> bool
        
        val gtb_tree : (string_t * t') -> tree -> bool
        ...
        type coq_R_min_elt =
        | R_min_elt_0 of tree
        | R_min_elt_1 of tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_min_elt_2 of tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree
           * elt option * coq_R_min_elt
        
        type coq_R_max_elt =
        | R_max_elt_0 of tree
        | R_max_elt_1 of tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_max_elt_2 of tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree
             ...
             sig 
              module OTF : 
               sig 
                ...
                val compare :
                  (string_t * t') -> (string_t * t') -> comparison
        ...
        type coq_R_bal =
        | R_bal_0 of t * (string_t * t') * t
        | R_bal_1 of t * (string_t * t') * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree
        | R_bal_2 of t * (string_t * t') * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree
        | R_bal_3 of t * (string_t * t') * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_bal_4 of t * (string_t * t') * t
        | R_bal_5 of t * (string_t * t') * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree
        | R_bal_6 of t * (string_t * t') * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree
        | R_bal_7 of t * (string_t * t') * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_bal_8 of t * (string_t * t') * t
        
        type coq_R_remove_min =
        | R_remove_min_0 of tree * elt * t
        | R_remove_min_1 of tree * elt * t * Int.Z_as_Int.t * tree
           * (string_t * t') * tree * (t * elt) * coq_R_remove_min * 
           t * elt
        
        type coq_R_merge =
        | R_merge_0 of tree * tree
        | R_merge_1 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_merge_2 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
           t * elt
        
        type coq_R_concat =
        | R_concat_0 of tree * tree
        | R_concat_1 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_concat_2 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
           t * elt
        
        type coq_R_inter =
        | R_inter_0 of tree * tree
        | R_inter_1 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_inter_2 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
           t * bool * t * tree * coq_R_inter * tree * coq_R_inter
        | R_inter_3 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
           t * bool * t * tree * coq_R_inter * tree * coq_R_inter
        
        type coq_R_diff =
        | R_diff_0 of tree * tree
        | R_diff_1 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_diff_2 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
           t * bool * t * tree * coq_R_diff * tree * coq_R_diff
        | R_diff_3 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
           t * bool * t * tree * coq_R_diff * tree * coq_R_diff
        
        type coq_R_union =
        | R_union_0 of tree * tree
        | R_union_1 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree
        | R_union_2 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
           * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * 
   ...
   sig 
    module Raw : 
     sig 
      ...
      val elements_aux : (string_t * t') list -> tree -> (string_t * t') list
      ...
      type coq_R_min_elt =
      | R_min_elt_0 of tree
      | R_min_elt_1 of tree * Int.Z_as_Int.t * tree * (string_t * t') * tree
      | R_min_elt_2 of tree * Int.Z_as_Int.t * tree * (string_t * t') * 
         tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * elt option
         * coq_R_min_elt
      
      type coq_R_max_elt =
      | R_max_elt_0 of tree
      | R_max_elt_1 of tree * Int.Z_as_Int.t * tree * (string_t * t') * tree
      | R_max_elt_2 of tree * Int.Z_as_Int.t * tree * (string_t * t') * 
         tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * elt option
         * coq_R_max_elt
      ...
      | R_remove_min_0 of tree * elt * t
      | R_remove_min_1 of tree * elt * t * Int.Z_as_Int.t * tree
         * (string_t * t') * tree * (t * elt) * coq_R_remove_min * t * 
         elt
      ...
      | R_merge_1 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
         * tree
      | R_merge_2 of tree * tree * Int.Z_as_Int.t * tree * (string_t * t')
         * tree * Int.Z_as_Int.t * tree * (string_t * t') * tree * t * 
         elt
