...
module Ops = 
 ...
 struct 
  ...
  | Leaf -> 0
  | Node (t0, l, t1, r) -> Pervasives.succ (plus (cardinal l) (cardinal r))
  
  (** val maxdepth : tree -> int **)
  
  let rec maxdepth = function
  | Leaf -> 0
  | Node (t0, l, t1, r) -> Pervasives.succ (max (maxdepth l) (maxdepth r))
  
  (** val mindepth : tree -> int **)
  
  let rec mindepth = function
  | Leaf -> 0
  | Node (t0, l, t1, r) -> Pervasives.succ (min (mindepth l) (mindepth r))
