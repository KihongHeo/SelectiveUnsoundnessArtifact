...
let update_mode_rect f f0 = function
| Weak -> f
| Strong -> f0

(** val update_mode_rec : 'a1 -> 'a1 -> update_mode -> 'a1 **)

let update_mode_rec f f0 = function
| Weak -> f
| Strong -> f0
...
let phase_t_rect f f0 f1 = function
| PrePhase -> f
| MainPhase -> f0
| ValiPhase -> f1
...
let phase_t_rec f f0 f1 = function
| PrePhase -> f
| MainPhase -> f0
| ValiPhase -> f1
...
let loc_type_rect f f0 f1 = function
| GVarLoc -> f
| LVarLoc x -> f0 x
| OtherLoc -> f1
...
let loc_type_rec f f0 f1 = function
| GVarLoc -> f
| LVarLoc x -> f0 x
| OtherLoc -> f1
...
(** val coq_MemBasic_rect :
    ...
    -> 'a4 -> 'a3 -> 'a1) -> ('a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1) -> ('a5 -> 'a2
    -> 'a4 -> 'a3 -> 'a1) -> 'a6) -> ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic
    -> 'a6 **)

let coq_MemBasic_rect f m =
  let { mem_find = x; mem_add = x0; mem_pre_add = x1; mem_main_add = x2;
    mem_weak_add = x3; mem_pre_weak_add = x4; mem_main_weak_add = x5 } = m
  in
...
(** val mem_find :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a2 -> 'a3 -> 'a1 **)

let mem_find x = x.mem_find

(** val mem_add :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1 **)

let mem_add x = x.mem_add

(** val mem_pre_add :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1 **)

let mem_pre_add x = x.mem_pre_add

(** val mem_main_add :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1 **)

let mem_main_add x = x.mem_main_add

(** val mem_weak_add :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1 **)

let mem_weak_add x = x.mem_weak_add

(** val mem_pre_weak_add :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1 **)

let mem_pre_weak_add x = x.mem_pre_weak_add

(** val mem_main_weak_add :
    ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3 -> 'a1 **)

let mem_main_weak_add x = x.mem_main_weak_add
