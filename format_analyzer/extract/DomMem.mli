 ...
 sig 
  ...
  module Mem : 
   sig 
          ...
          module L : 
           sig 
            ...
            val coq_R_equal_rect :
              ...
              (string_t * t', (unit, string_t) sum) sum) sum * string_t
              list) * 'a1) list -> __ -> __ -> __ -> bool -> 'a1 coq_R_equal
            ...
            val equal_rect :
              ...
              list) -> 'a1 -> ((((string_t, string_t * string_t) sum,
              (string_t * t', (unit, string_t) sum) sum) sum * string_t
              list) * 'a1) list -> __ -> __ -> __ -> 'a2 -> 'a2) -> ('a1 t ->
    ...
    val find :
      (((string_t, string_t * string_t) sum, (string_t * t', (unit, string_t)
      sum) sum) sum * string_t list) -> t -> Val.t
    
    val add :
      (((string_t, string_t * string_t) sum, (string_t * t', (unit, string_t)
      sum) sum) sum * string_t list) -> Val.t -> t -> t
    ...
    val mapi :
      ((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) -> Val.t -> Val.t) -> t -> t
    
    val fold : (Val.t -> 'a1 -> 'a1) -> t -> 'a1 -> 'a1
    
    val foldi :
      ((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) -> Val.t -> 'a1 -> 'a1) -> t
      -> 'a1 -> 'a1
    
    val filteri :
      ((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) -> Val.t -> bool) -> t -> t
    
    val elements :
      t -> ((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) * Val.t) list
    
    val cardinal : t -> int
    
    val le_than :
      t -> (((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) -> Val.t -> bool
    
    val for_all :
      ((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) -> Val.t -> unit) ->
      ((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) -> Val.t -> bool) -> t -> bool
    
    val unstables :
      t -> t -> (Val.t -> Val.t -> bool) -> (((string_t, string_t * string_t)
      sum, (string_t * t', (unit, string_t) sum) sum) sum * string_t list)
      list -> (((((string_t, string_t * string_t) sum, (string_t * t', (unit,
      string_t) sum) sum) sum * string_t list) * Val.t) * Val.t) list
    ...
    val coq_IMap :
      (((string_t, string_t * string_t) sum, (string_t * t', (unit, string_t)
      sum) sum) sum * string_t list, Val.t, t) coq_TCMap
   end
  ...
  val find :
    ...
    string_t) sum) sum) sum * string_t list) -> t -> Val.t
  
  val add :
    PowLoc.t -> (((string_t, string_t * string_t) sum,
    (string_t * IntraNode.t', (unit, string_t) sum) sum) sum * string_t list)
    -> Val.t -> t -> t
  ...
  val unstables :
    t -> t -> (Val.t -> Val.t -> bool) -> (((string_t, string_t * string_t)
    sum, (string_t * IntraNode.t', (unit, string_t) sum) sum) sum * string_t
    list) list -> (((((string_t, string_t * string_t) sum,
    (string_t * IntraNode.t', (unit, string_t) sum) sum) sum * string_t
    list) * Val.t) * Val.t) list
  
  val meet_big_small : t -> t -> t
  
  val le_than :
    t -> (((string_t, string_t * string_t) sum, (string_t * IntraNode.t',
    (unit, string_t) sum) sum) sum * string_t list) -> Val.t -> bool
...
module G : 
 sig 
  type t = { icfg : InterCfg.t; callgraph : Global.Callgraph.t; dump : Dump.t }
  
  val t_rect :
    (InterCfg.t -> Global.Callgraph.t -> Dump.t -> 'a1) -> t -> 'a1
  
  val t_rec : (InterCfg.t -> Global.Callgraph.t -> Dump.t -> 'a1) -> t -> 'a1
...
module Table : 
 sig 
        ...
        module L : 
         sig 
          ...
          val coq_R_mem_rect :
            ...
            t -> (string_t * t') -> 'a1 -> ((string_t * t') * 'a1) list -> __
            -> __ -> __ -> 'a2) -> ('a1 t -> (string_t * t') -> 'a1 ->
          ...
          val coq_R_find_rect :
            ...
            t -> (string_t * t') -> 'a1 -> ((string_t * t') * 'a1) list -> __
            -> __ -> __ -> 'a2) -> ('a1 t -> (string_t * t') -> 'a1 ->
            ((string_t * t') * 'a1) list -> __ -> __ -> __ -> 'a1 option ->
          ...
          val fold_rect :
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> __ -> 'a2) ->
            (__ -> (key -> 'a1 -> __ -> __) -> 'a1 t -> __ -> (string_t * t')
            -> 'a1 -> ((string_t * t') * 'a1) list -> __ -> 'a2 -> 'a2) ->
            (key -> 'a1 -> 'a3 -> 'a3) -> 'a1 t -> 'a3 -> 'a2
          ...
          val coq_R_equal_rect :
            ...
            ((string_t * t') * 'a1) list -> __ -> __ -> __ -> bool -> 'a1
            coq_R_equal -> 'a2 -> 'a2) -> ('a1 t -> 'a1 t -> (string_t * t')
            -> 'a1 -> ((string_t * t') * 'a1) list -> __ -> (string_t * t')
            -> 'a1 -> ((string_t * t') * 'a1) list -> __ -> (string_t * t')
            OrderedType.coq_Compare -> __ -> __ -> 'a2) -> ('a1 t -> 'a1 t ->
            'a1 t -> __ -> 'a1 t -> __ -> __ -> 'a2) -> 'a1 t -> 'a1 t ->
  ...
  val for_all :
    ((string_t * t') -> Mem.t -> unit) -> ((string_t * t') -> Mem.t -> bool)
    -> t -> bool
...
val add :
  param -> ('a1, 'a2, 'a3, 'a4, 'a5) coq_MemBasic -> 'a5 -> 'a2 -> 'a4 -> 'a3
  -> 'a1
